...
export default function Navbar() {
    ...
    return (
        <nav data-v-3ed40230 className={`fixed px-2 z-40 top-0 left-0 w-full  ${scroll > 0 ? 'bg-white bg-opacity-60 backdrop-blur' : ''}`}>
            <div className='max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl mx-auto'>
                <div className='flex justify-between items-stretch py-2 gap-4'>
                    <div className='flex-1 items-center gap-3 hidden lg:flex'>
                        ...
                        <a data-v-3ed40230 className={`nav-link ${scroll > 0 ? 'text-black opacity-60' : 'nav-link-dark'}`} href="#">DISCORD</a>
                        <a data-v-3ed40230 className={`nav-link ${scroll > 0 ? 'text-black opacity-60' : 'nav-link-dark'}`} href="#">HỘI KÍN</a>
                        <a data-v-3ed40230 className={`nav-link ${scroll > 0 ? 'text-black opacity-60' : 'nav-link-dark'}`} href="#">ĐĂNG TRUYỆN</a>
                        <a data-v-3ed40230 className={`nav-link ${scroll > 0 ? 'text-black opacity-60' : 'nav-link-dark'}`} href="#">TIN TỨC</a>
                    </div>
                    <div className='flex-1 flex lg:justify-center items-center max-w-full'>
                        <a data-v-3ed40230 className={`font-display font-extrabold uppercase select-none rounded-full flex items-center h-11 router-link-exact-active router-link-active ${scroll > 0 ? 'text-black text-opacity-60' : 'text-white'}  `} href="/">Cứu truyện</a>
                    </div>
                    <div data-v-3ed40230 className='flex-1 flex justify-end max-w-full'>
                        <button data-v-3ed40230 className='button-circle px-3 py-2 mr-2 h-11 w-11 flex justify-center items-center button-transparent-dark'>
                        ...
                        <a href='#' data-v-3ed40230 className='button-circle px-3 py-2 mr-2 h-11 w-11 flex justify-center items-center relative button-transparent-dark'>
                            <span data-v-3ed40230 className='material-design-icon magnify-icon'>
