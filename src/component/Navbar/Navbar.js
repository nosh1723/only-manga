...
export default function Navbar() {
  return (
    <nav data-v-3ed40230 className='fixed px-2 z-40 top-0 left-0 w-full'>
        <div className='max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl mx-auto'>
            <div className='flex justify-between items-stretch py-2 gap-4'>
                <div className='flex-1 items-center gap-3 hidden lg:flex'>
                    ...
                    <a data-v-3ed40230 className='nav-link nav-link-dark' href="#">DISCORD</a>
                    <a data-v-3ed40230 className='nav-link nav-link-dark' href="#">HỘI KÍN</a>
                    <a data-v-3ed40230 className='nav-link nav-link-dark' href="#">ĐĂNG TRUYỆN</a>
                    <a data-v-3ed40230 className='nav-link nav-link-dark' href="#">TIN TỨC</a>
                </div>
                <div className='flex-1 flex lg:justify-center items-center max-w-full'>
                    <a data-v-3ed40230 className='font-display font-extrabold uppercase select-none rounded-full flex items-center h-11 router-link-exact-active router-link-active text-white text-opacity-60' href="/">Cứu truyện</a>
                </div>
                <div data-v-3ed40230 className='flex-1 flex justify-end max-w-full'>
                    ...
                    <div data-v-3ed40230 className='relative'>
                        <button className='button-circle px-4 py-2 h-11 w-11 flex justify-center items-center uppercase button-transparent-dark'>b</button>
